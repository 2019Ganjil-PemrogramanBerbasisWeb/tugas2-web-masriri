...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["username"]))) {
        ...
        $sql = "SELECT no FROM users WHERE username = ?";
...
<header id="header" class="alt">
    ...
    <div class="wrapper">
        <h2>Sign Up</h2>
        <p style="float: left;">Please fill this form to create an account.</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p style="float: left;">Already have an account? <a href="login.php">Login here</a>.</p>
        </form>
    </div>
    </center>
